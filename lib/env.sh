...
: "${AI_INSTALL_OPTIONAL_BACKENDS:=1}"
...
: "${AI_VLLM_EXTRA_ARGS:=--trust-remote-code}"
...
export AI_HOME AI_PROJECTS AI_HERMES_HOME AI_OPENCODE_HOME
...
export AI_SYNC_LOCAL_ROOT AI_SYNC_AI_HOME AI_SYNC_DELETE AI_REQUIRE_SYNC_CONFIG AI_INSTALL_OPTIONAL_BACKENDS
